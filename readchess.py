...
class ReadChess(object):
    ...
    def __init__(self, chessboard=[[0, 0, 0], [0, 0, 0], [0, 0, 0]]):
        # super(ReadChess, self).__init__()
        self.__IMAGE_WIDTH = 36
        self.__IMAGE_HIGHT = 36
        self.__SIZE = len(chessboard) * len(chessboard)
    ...
    def getChess(self):
        ...
        # point to remap
        points1 = numpy.array([numpy.array([0.0, 0.0], numpy.float32) + numpy.array([324, 0], numpy.float32), numpy.array([0.0, 0.0], numpy.float32),
                               numpy.array([0.0, 0.0], numpy.float32) + numpy.array([0.0, 324], numpy.float32), numpy.array([0.0, 0.0], numpy.float32) + numpy.array([324, 324], numpy.float32), ], numpy.float32)
